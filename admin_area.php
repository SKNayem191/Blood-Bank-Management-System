	...
	<div class="row">
		...
		<div class="col-sm-9" >
			...
			<div class="row">
				...
				{
				 $sql="INSERT INTO area(STATE_ID,AREA_NAME) VALUES ('".$_POST[""]."','".$_POST["statename"]."','".$_POST["areaname"]."')";
					$con->query($sql);
...
Select state.STATE_NAME, area.AREA_NAME, area.AREA_ID
From area Inner Join
state On area.STATE_ID = state.STATE_ID
