		    ...
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-envelope "> </span> Request for Blood</h3>
                    </div>
					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
						   ...
						   <div class="form-group"><center>
							<button class="button button1" id="BTN" name="submit"> Request Now</button>
						  </div>
						 </form>
                    </div>
                </div>
