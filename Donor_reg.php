                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="form-group">
								<label class="control-label text-primary" for="STATE">Division</label>
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
                                ...
                                <input type="text" required name="CONTACT_1" id="CONTACT_1" class="form-control" placeholder="Your Contact">
                          </div>
						...
						<div class="form-group">
						  ...
						  <div class="form-group"><center>
							<button class="button button1" type="submit" name="submit" >Registar Now</button>
						  </div>
						 </form>
                    </div>
                </div>
